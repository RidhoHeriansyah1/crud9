        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/mastersport" method="POST">
                        <br>
                        @csrf
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Nama</label>
                            <input type="text" name="nama" class="form-control" id="exampleFormControlInput1"
                                placeholder="Masukan Nama Lengkap Anda" value="{{ Session::get('nama') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" name="nis" class="form-control" id="exampleFormControllabel1"
                                placeholder="Masukan NIS Anda" value="{{ Session::get('nis') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="alamat" id="exampleFormControlTextarea1" placeholder="Masukan Alamat Lengkap Anda"
                                rows="3">{{ Session::get('alamat') }}</textarea>
                        </div>
